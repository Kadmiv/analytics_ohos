...
/// HarmonyOS NEXT / OpenHarmony Analytics Engine.
///
/// Implements [AnalyticsEngine] for Huawei HiAnalytics & OpenHarmony S2S platforms.
class OhosAnalyticsEngine extends BaseAnalyticsEngine {
  ...
  Future<void> initialize() async {
    ...
    _logger.i('OhosAnalyticsEngine: Initializing HarmonyOS Analytics');
